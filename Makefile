...
zip-release-thunderstore:
	$(7Z) a -bd -aoa -tzip "releases/$(MOD_AUTHOR)-$(MOD_NAME)-$(MOD_VERSION).zip" ./manifest.json ./icon.png ./thunderstore/README.md ./bin/Release/$(TARGET_FRAMEWORK)/$(MOD_NAME).dll
...
zip-debug-thunderstore:
	$(7Z) a -bd -aoa -tzip "releases/$(MOD_AUTHOR)-$(MOD_NAME)-$(MOD_VERSION)_debug.zip" ./manifest.json ./icon.png ./thunderstore/README.md ./bin/Debug/$(TARGET_FRAMEWORK)/$(MOD_NAME).dll
